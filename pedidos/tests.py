...
class CuponNATIVO25TestCase(TestCase):
    def setUp(self):
    ...
    def test_aplicar_cupon_primer_pedido(self):
        ...
        # Aplicar cupón NATIVO25
        response_coupon = self.client.post(reverse("pedidos:aplicar_cupon"), {"codigo_cupon": "NATIVO25"})
        self.assertEqual(response_coupon.status_code, 302)
        self.assertEqual(self.client.session.get("cupon_aplicado"), "NATIVO25")
        ...
        self.assertEqual(pedido.cupon, "NATIVO25")
    ...
    def test_rehusar_cupon_segundo_pedido(self):
        ...
        # Intentar aplicar cupón NATIVO25
        response_coupon = self.client.post(reverse("pedidos:aplicar_cupon"), {"codigo_cupon": "NATIVO25"})
        self.assertEqual(response_coupon.status_code, 302)
