...
class NegocioForm(forms.ModelForm):
    class Meta:
        model = Negocio
        exclude = ['propietario', 'destacado', 'creado_en', 'actualizado_en', 'creado_por', 'activo']
...
class SedeForm(forms.ModelForm):
    class Meta:
        model = Sede
        exclude = ['negocio', 'estado', 'creado_en', 'actualizado_en', 'creado_por', 'activo']
        widgets = {
...
class ProductoForm(forms.ModelForm):
    class Meta:
        model = Producto
        exclude = ['creado_en', 'actualizado_en', 'creado_por', 'activo']
